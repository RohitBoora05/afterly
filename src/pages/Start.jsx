...
// Tone: peer recommendation, not ad.
      ...
      <section style={{
        ...
        <div style={{
          ...
          >
            ...
            <span style={{ color: PAL.muted }}>you will do.</span>
          </Heading>
          <p style={{
            ...
            afterly is a small app built to help with the moments willpower runs out.
          </p>
          <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <Heading size={mobile ? 42 : 76}
            ...
            <span style={{ color: PAL.accent }}>A lot of people are in the exact same place.</span>
          </Heading>
          <p style={{
